...
پیشرفت نصب در session مرورگر نگه‌داری می‌شود تا بارگذاری مجدد صفحه باعث از دست رفتن اطلاعات نشود. در هر مرحله می‌توانید با «بازگشت» مرحله قبل را اصلاح کنید یا با «شروع مجدد» session نصب را پاک کرده و از ابتدا آغاز کنید. اگر دیتابیس در میانه نصب بیرون از برنامه حذف شود، نصب‌کننده وضعیت نامعتبر را تشخیص می‌دهد و به مرحله تنظیمات دیتابیس بازمی‌گردد.
