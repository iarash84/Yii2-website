...
ارسال ایمیل با افزونه رسمی `yiisoft/yii2-symfonymailer` انجام می‌شود. حالت‌های بدون رمزنگاری، STARTTLS و SSL از پنل قابل انتخاب‌اند؛ در production از STARTTLS یا SSL و گواهی معتبر سرویس‌دهنده استفاده کنید.
